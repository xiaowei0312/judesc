...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", username=" + username + ", password=" + password + ", province=" + province
				+ ", city=" + city + ", area=" + area + ", phone=" + phone + ", headImgUrl=" + headImgUrl + ", openId="
				+ openId + ", getCashFlag=" + getCashFlag + ", incomFlag=" + incomFlag + "]";
	}
