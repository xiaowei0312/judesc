...
public class UserServiceImpl implements UserService {
	...
	@Override
	public List<PlatformSyDistributedRecordExpand> getSyAccountRecord(Integer userId)
			throws Exception {
	...
	@Override
	public List<JournalBookExpand> findAllJournalBookRecordsByClientId(Integer userId)
			throws Exception {
		return userMapper.queryAllJournalBookRecordsByClientId(userId);
	}
