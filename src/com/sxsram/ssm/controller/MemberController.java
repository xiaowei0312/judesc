...
public class MemberController {
	...
	@RequestMapping(value = "/member/exit", method = { RequestMethod.GET })
	public String userExit(HttpSession session, Model model) {
		session.removeAttribute("user");
		return "redirect:/main/index";
	}

	@RequestMapping(value = "/member/registPage", method = { RequestMethod.GET })
	public String userRegistPage(HttpSession session, Model model) {
		return "regist";
	}

	@RequestMapping(value = "/member/registerValidate", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/registSubmitAjax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public String regist(UserExpand userExpand, HttpServletRequest request, HttpSession session, Model model,
		...
		try {
			...
			return gson.toJson(new JsonResult("0", "0", "", null, request.getContextPath() + "/member/center"));
		} catch (Exception e) {
			e.printStackTrace();
	...
	@RequestMapping(value = "/member/loginPage", method = { RequestMethod.GET, RequestMethod.POST })
	public String userLoginPage(HttpSession session, Model model) {
		return "login";
	}

	@RequestMapping(value = "/member/loginSubmitAjax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	public String userLogin(HttpSession session, HttpServletRequest request, Model model, UserExpand inputUser,
		...
		jsonResult.url = request.getContextPath() + "/member/center";
		return gson.toJson(jsonResult);
	}
	...
	@RequestMapping(value = "/member/moneyChangeRecord", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/member/syChangeRecord", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/member/jfChangeRecord", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/member/dlbChangeRecord", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/member/jdbChangeRecord", method = { RequestMethod.GET })
	public String jdbChangeRecord(HttpSession session, Model model) {
		UserExpand user = (UserExpand) session.getAttribute("user");
		UserExpandQueryVo userExpandQueryVo = new UserExpandQueryVo();
		userExpandQueryVo.setId(user.getId());
		// userExpandQueryVo.setPagination(new Pagination(7, 1, null,
		...
		if (totalNum == null)
			totalNum = 0;
		model.addAttribute("totalNum", totalNum);
		return "jdbChangeRecord";
	}

	@RequestMapping(value = "/member/yljTransferRecord", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/member/onlineConsumeRecord", method = { RequestMethod.GET })
	public String onlineConsumeRecord(HttpSession session, Model model) {
		...
		if (totalNum == null)
			totalNum = 0;
		model.addAttribute("totalNum", totalNum);
		return "onlineConsumeRecord";
	}

	@RequestMapping(value = "/member/offlineConsumeRecord", method = { RequestMethod.GET })
	...
	@RequestMapping(value = "/member/moneyChangeRecordAjax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/syChangeRecordAjax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/jfChangeRecordAjax", method = { RequestMethod.GET })
	@ResponseBody
	...
	@RequestMapping(value = "/member/dlbChangeRecordAjax", method = { RequestMethod.GET })
	@ResponseBody
	...
	@RequestMapping(value = "/member/jdbChangeRecordAjax", method = { RequestMethod.GET })
	@ResponseBody
	public String jdbChangeRecordAjax(HttpSession session, Model model, Integer page, Integer size, Integer totalSize) {
		UserExpand user = (UserExpand) session.getAttribute("user");
		UserExpandQueryVo userExpandQueryVo = new UserExpandQueryVo();
		userExpandQueryVo.setId(user.getId());
		userExpandQueryVo.setPagination(new Pagination(size, page, null, "{\"operateTime\":\"desc\"}"));
		...
		Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").create();
		JsonResult jsonResult = new JsonResult("0", "0");
		jsonResult.resultObj = new PageObj(totalSize, jdbAccountRecordExpands);
		return gson.toJson(jsonResult);
	}

	@RequestMapping(value = "/member/yljTransferAjax", method = { RequestMethod.GET })
	@ResponseBody
	...
	@RequestMapping(value = "/member/onlineConsumeRecordAjax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/offlineConsumeRecordAjax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/changePwdValidate1", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/changePwdValidate2", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/selfInfo", method = { RequestMethod.GET })
	public String selfInfo(HttpSession session, Model model) {
		return "selfInfo";
	}

	@RequestMapping(value = "/member/lostPwd", method = { RequestMethod.GET })
	public String forgetPwd(HttpSession session, Model model) {
		return "lostPwd";
	}

	@RequestMapping(value = "/member/lostPwdSubmitAjax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/lostPwdSubmit", method = { RequestMethod.GET, RequestMethod.POST })
	public String lostPwdSubmit(HttpSession session, Model model, String phone) {
		model.addAttribute("phone", phone);
		return "lostPwd1";
	}

	@RequestMapping(value = "/member/lostPwdSubmit1Ajax", method = { RequestMethod.GET, RequestMethod.POST })
	@ResponseBody
	...
	@RequestMapping(value = "/member/lostPwdSuccess", method = { RequestMethod.GET, RequestMethod.POST })
