...
public class IpAddressUtil {
	 ...
	 */
	public CommonAddress getAddresses(String content, String encodingString) throws UnsupportedEncodingException {
		...
		if (returnStr != null) {
			...
			for (int i = 0; i < temp.length; i++) {
				...
				case 1:
					...
					commonAddress.setCountry(country);
					break;
				case 3:
				...
				case 5:
					...
					region = decodeUnicode(region);// 省份
					commonAddress.setProvince(region);
					break;
				case 7:
				...
				case 9:
					...
					commonAddress.setCounty(county);
					break;
				case 11:
					isp = (temp[i].split(":"))[1].replaceAll("\"", "");
					isp = decodeUnicode(isp); // ISP公司
					commonAddress.setIsp(isp);
					break;
				}
			}
	...
	public static CommonAddress getAddressByIp(String ipstr) {
		IpAddressUtil ipAddressUtil = new IpAddressUtil();
		try {
			return ipAddressUtil.getAddresses("ip=" + ipstr, "utf-8");
