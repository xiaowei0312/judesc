...
public class StringUtil extends StringUtils {
	...
	// * @return
	// */
	// public static <T> List<T> mapToList(Class<T> clazz, List<Map<String,
	// Object>> list) {
	//
	...
	// for (Iterator<Map<String, Object>> iter = list.iterator();
	// iter.hasNext();) {
	// map = iter.next();
	...
	// setMethod = clazz.getMethod(setName, fieldClass);
	// setMethod.invoke(o,
	// BigInteger.valueOf(Long.parseLong(String.valueOf(value))));// 为其赋值
	// } else if (fieldClass == BigDecimal.class) {
	// setMethod = clazz.getMethod(setName, fieldClass);
	// setMethod.invoke(o,
	// BigDecimal.valueOf(Double.parseDouble(String.valueOf(value))));// 为其赋值
	...
	// }
	//
	// public static <T> T requestToObject(HttpServletRequest request, Class<T>
	// clazz) {
	//
	// if (null == request) {
	// return null;
	...
	// } else if (fieldClass == Boolean.class || fieldClass == boolean.class) {
	// setMethod = clazz.getMethod(setName, fieldClass);
	// setMethod.invoke(entity, Boolean.getBoolean(String.valueOf(value)));//
	// 为其赋值
	// } else if (fieldClass == Short.class || fieldClass == short.class) {
	// setMethod = clazz.getMethod(setName, fieldClass);
	...
	// } else if (fieldClass == Double.class || fieldClass == double.class) {
	// setMethod = clazz.getMethod(setName, fieldClass);
	// setMethod.invoke(entity, Double.parseDouble(String.valueOf(value)));//
	// 为其赋值
	// } else if (fieldClass == Float.class || fieldClass == float.class) {
	// setMethod = clazz.getMethod(setName, fieldClass);
	...
	// */
	// public static void beanCopy(Object source, Object target, boolean
	// isCopyNull) {
	//
	// if (null == source || null == target) {
	// return;
	...
	static Boolean isEmptyIgnoreBlank(String str) {
